...
contract RendererTest is DSTest {
    ...
    function setUp() external {
        ...
        items.setEntropy(68562724416325610796240657452269054350938555025195199344624191120807109082480 );
    ...
    function test_getMetadataUnrevealed() external {
        heroes.setEntropy(0);
    ...
    function test_getMetadata_item() external {
        ...
        string memory meta = items.tokenURI(11900);
    ...
    function setAllSigs() public {
        ...
        renderer.setSvg(0x4c4884d9, address(inv));
        renderer.setSvg(0x85de3727, address(inv));
        renderer.setSvg(0x667b73fd, address(inv));
        renderer.setSvg(0x2f50ec9c, address(inv));
        renderer.setSvg(0x9ff02635, address(inv));
        renderer.setSvg(0x7a1c412d, address(inv));
        renderer.setSvg(0xbbe636ff, address(inv));
        renderer.setSvg(0xf8bd48df, address(inv));
        renderer.setSvg(0xad6d75b3, address(inv));
